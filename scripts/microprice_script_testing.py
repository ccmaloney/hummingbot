...
class MicropricePMM(ScriptStrategyBase):
    ...
    def on_tick(self):
        ...
        if self.create_timestamp <= self.current_timestamp:
            ...
            self.logger().info((f"Adjusted Midprice: {self.compute_adjusted_midprice()}"))
...
# ! Data methods
    ...
    def compute_adjusted_midprice(self):
        ...
        self.logger().info(f"{spread_bucket}")
        # Compute adjusted midprice
    ...
    def get_df(self):
        ...
        try:
            ...
            df = pd.concat([df, self.current_dataframe], ignore_index=True)
